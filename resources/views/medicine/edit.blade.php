                ...
                <form action="{{ route('medicine.update') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input id="Name" type="text" name="name" value="{{$medicine->name}}" class="form-control" required>
                        </div>
                        <div class="col">
                            ...
                            <select name="available" id="available" class="custom-select my-1 mr-sm-2" required>
                                <option value="{{$medicine->status}}">{{$val}}</option>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input id="place_where" type="text" value="{{$medicine->place_where}}" name="place_where" class="form-control" required>
                        </div>
                        <div class="col">
                            <label for="price" class="mr-sm-2">Price</label>
                            <input id="price" type="number" value="{{$medicine->price}}" name="price" class="form-control" required>
                        </div>
                    </div>
                    <br>
                    <div class="row mt-1">
                        <div class="col">
                            ...
                            <input id="alternatives" type="text" value="{{$medicine->alternatives}}" name="alternatives" class="form-control" required>
                        </div>
                    </div>
                    <div class="row mt-1">
                        <div class="col">
                            ...
                            class="form-control" required>{{$medicine->combination}}</textarea>
                        </div>
                    </div>
                    <div class="row mt-1">
                        <div class="col">
